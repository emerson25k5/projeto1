	...
	<body>
		...
		<main class="box container">
				...
				<div class="row">
					...
					<!-- form para a 1° tabela a de dados gerais-->
					<form id="form1" name="form1" action="atualizaCadastro.php" method="post">
						...
						<div id="option1" class="col s12">
							...
							<?php echo lista_suspensa_genero($genero);?><br>
							...
							<label for="dataCad">Data e hora do cadastro:</label>
							...
							<label for="responsavelCadastro">Resposável pelo cadastro:</label>
					...
					<!-- form para a 4° tabela a de uniformes-->
